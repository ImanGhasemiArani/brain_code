...
class L12ObjController extends LevelObjController {
  @override
  ...
  @override
  final List<String> hints = [Strs.l12Tip1];
}

class L12 extends StatefulWidget {
  const L12(this.controller, {super.key});

  final L12ObjController controller;

  @override
  State<L12> createState() => _L12State();
}

class _L12State extends State<L12> {
  @override
